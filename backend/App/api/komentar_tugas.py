...
@router.get("/task/{tugas_id}", response_model=List[KomentarTugasResponse]) 
...
@router.post("/", response_model=KomentarTugasResponse, status_code=status.HTTP_201_CREATED) 
